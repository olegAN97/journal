...
class TestsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'run_time' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'run_time' => '2017-12-08 19:11:41',
            'created' => '2017-12-08 19:11:41',
            'modified' => '2017-12-08 19:11:41'
        ],
    ];
}
